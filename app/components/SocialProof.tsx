                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="w-16 h-16 bg-slate-700 rounded-full overflow-hidden border-2 border-accent-500">
                                {/* Placeholder for Joachim's photo */}
                                <div className="w-full h-full bg-slate-600 flex items-center justify-center text-xs text-slate-400">
                            ...
                            <div>
                                ...
                                <div className="text-slate-400">Expert en digitalisation BTP & Transport</div>
                            </div>
                        </div>

                        <div className="mt-12 pt-12 border-t border-slate-800 grid grid-cols-3 gap-8">
                            <div>
                            ...
                            <div>
                                ...
                                <div className="text-sm text-slate-400">Sur mesure</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 backdrop-blur-sm">
                        ...
                        <div className="space-y-6">
                            <div className="p-4 bg-slate-800 rounded-xl border border-slate-700/50">
                                <p className="text-slate-300 italic mb-4">"Avant, je passais mes week-ends à faire des devis. Aujourd'hui, tout est prêt le vendredi soir. L'équipe a adopté l'outil en 2 semaines."</p>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-400">Gérant, JM Transports (20 salariés)</div>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 bg-slate-800 rounded-xl border border-slate-700/50">
                                <p className="text-slate-300 italic mb-4">"Enfin quelqu'un qui comprend notre métier. Pas de jargon technique, que du concret. La rentabilité par chantier est devenue limpide."</p>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-400">Dirigeante, BatiRenov (12 salariés)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
