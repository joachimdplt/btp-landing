    ...
    return (
        <section className="relative overflow-hidden bg-slate-900 pt-20 pb-32 lg:pt-32 lg:pb-40">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight mb-6 font-heading leading-tight">
                        Transformez votre entreprise en <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-accent-400">machine opérationnelle</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <button className="px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-xl font-semibold text-lg transition-all shadow-lg shadow-primary-900/20 flex items-center gap-2 group">
                            Demander un audit gratuit
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </button>
                        <button className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-xl font-semibold text-lg transition-all">
            ...
            <div className="mt-16 container mx-auto px-4 relative z-10">
                <div className="relative rounded-xl bg-slate-800/50 border border-slate-700/50 p-2 md:p-4 shadow-2xl max-w-5xl mx-auto backdrop-blur-sm">
                    <div className="absolute inset-0 bg-gradient-to-b from-primary-500/5 to-transparent rounded-xl pointer-events-none" />
                    <div className="aspect-[16/9] bg-slate-900 rounded-lg overflow-hidden relative border border-slate-800">
                        {/* Placeholder for UI Mockup */}
                        <div className="absolute inset-0 flex items-center justify-center text-slate-600">
                            <div className="text-center">
                                <p className="text-sm uppercase tracking-widest mb-2">Interface de Pilotage</p>
                                <div className="w-32 h-1 bg-slate-800 mx-auto rounded-full overflow-hidden">
                        ...
                        {/* Mock UI Elements */}
                        <div className="absolute top-4 left-4 right-4 h-12 bg-slate-800/50 rounded flex items-center px-4 gap-4 border border-slate-700/50">
                            <div className="w-32 h-4 bg-slate-700 rounded" />
                            <div className="flex-1" />
                            <div className="w-8 h-8 rounded-full bg-slate-700" />
                        </div>
                        <div className="absolute top-20 left-4 w-64 bottom-4 bg-slate-800/30 rounded border border-slate-700/30 p-4 hidden md:block">
                            <div className="w-full h-4 bg-slate-700/50 rounded mb-4" />
                        ...
                        <div className="absolute top-20 left-4 md:left-72 right-4 bottom-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-slate-800/30 rounded border border-slate-700/30 p-4">
                                <div className="flex justify-between mb-4">
                                    <div className="w-24 h-4 bg-slate-700/50 rounded" />
                                    <div className="w-4 h-4 bg-accent-500 rounded-full" />
                                </div>
                                <div className="space-y-2">
                                    <div className="w-full h-20 bg-slate-700/20 rounded" />
                                    <div className="w-full h-8 bg-slate-700/20 rounded" />
                                </div>
                            </div>
                            <div className="bg-slate-800/30 rounded border border-slate-700/30 p-4">
                                <div className="flex justify-between mb-4">
