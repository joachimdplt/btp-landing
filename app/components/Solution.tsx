                ...
                <div className="space-y-24">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        <div className="lg:w-1/2 order-2 lg:order-1">
                            <div className="relative rounded-2xl bg-white shadow-2xl border border-slate-100 p-2 transform -rotate-1 hover:rotate-0 transition-transform duration-500">
                                <div className="aspect-[4/3] bg-slate-100 rounded-xl overflow-hidden relative">
                                    {/* Abstract UI: Dashboard */}
                                    <div className="absolute inset-0 bg-slate-900 p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="bg-slate-800 p-4 rounded-lg border border-slate-700">
                                                ...
                                                <div className="w-16 h-4 bg-slate-600 rounded mb-1" />
                                                <div className="w-24 h-6 bg-slate-500 rounded" />
                                            </div>
                                            <div className="bg-slate-800 p-4 rounded-lg border border-slate-700">
                                            ...
                                            <div className="col-span-2 bg-slate-800 p-4 rounded-lg border border-slate-700 h-32">
                                                <div className="w-full h-full bg-slate-700/20 rounded" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="lg:w-1/2 order-1 lg:order-2">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mb-4">Cockpit de pilotage en temps réel</h3>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        <div className="lg:w-1/2">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mb-4">Pensé "Terrain-First"</h3>
                            <p className="text-slate-600 text-lg leading-relaxed mb-6">
                            ...
                            <div className="relative mx-auto w-[300px] h-[600px] bg-slate-900 rounded-[3rem] border-8 border-slate-800 shadow-2xl overflow-hidden">
                                ...
                                <div className="h-full w-full bg-white pt-12 px-4 pb-4 flex flex-col">
                                    ...
                                    <div className="space-y-3 flex-1 overflow-hidden">
                                        {[1, 2, 3, 4].map((i) => (
                                            <div key={i} className="p-3 border border-slate-100 rounded-lg flex items-center gap-3">
                                    ...
                                    <div className="mt-4 h-14 bg-slate-900 rounded-xl flex items-center justify-center text-white font-medium">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        <div className="lg:w-1/2 order-2 lg:order-1">
                            <div className="relative rounded-2xl bg-white shadow-xl border border-slate-100 p-8">
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-semibold text-slate-900">Devis #2024-042</div>
                                                <div className="text-sm text-slate-500">Validé par le client</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-semibold text-slate-900">Chantier Créé</div>
                                                <div className="text-sm text-slate-500">Planning mis à jour auto.</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-semibold text-slate-900">Facture Générée</div>
                                                <div className="text-sm text-slate-500">Envoyée au client</div>
                                            </div>
                                        </div>
                        ...
                        <div className="lg:w-1/2 order-1 lg:order-2">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mb-4">Zéro double saisie</h3>
                            <p className="text-slate-600 text-lg leading-relaxed mb-6">
